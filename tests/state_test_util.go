...
import (
	...
	"github.com/livepeer/go-ethereum/core/state"
...
// See https://github.com/livepeer/EIPs/issues/176 for the test format specification.
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/livepeer/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
